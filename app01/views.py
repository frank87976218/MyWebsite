...
def news(request):
    import requests
    res = requests.get("https://kemono.games/_next/data/sh7XB1p3e80xXeC5Gta0Q/zh-Hant/game/Firefighter-Connor/comment."
                       "json?gameSlug=Firefighter-Connor&tab=comment")
    data_list = res.json()
